...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/cosmonaut/leaderboard/leaderboard/player_info
   */
  queryPlayerInfoAll = (
    query?: {
    ...
    this.request<LeaderboardQueryAllPlayerInfoResponse, RpcStatus>({
      path: `/cosmonaut/leaderboard/leaderboard/player_info`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/cosmonaut/leaderboard/leaderboard/player_info/{index}
   */
  queryPlayerInfo = (index: string, params: RequestParams = {}) =>
    this.request<LeaderboardQueryGetPlayerInfoResponse, RpcStatus>({
      path: `/cosmonaut/leaderboard/leaderboard/player_info/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
